...
import { 
  FaMapMarkerAlt, FaPhone, FaEnvelope, FaClock, FaFacebook, FaInstagram, 
  FaPinterest, FaPaperPlane, FaUser, FaEnvelopeOpen, FaChevronDown, FaMap,
  FaQuestionCircle, FaCalendarAlt
} from 'react-icons/fa';
...
const ContactPage = () => {
  ...
  const faqItems = [
    {
      ...
      answer: "Our custom pieces typically take 6-8 weeks from design approval to completion. Complex designs may take longer."
    },
    {
      question: "Do you offer international shipping?",
      answer: "Yes, we ship worldwide. Shipping costs and times vary based on location and size of the furniture."
    },
    {
      question: "What materials do you use?",
      answer: "We use sustainably sourced hardwoods, premium upholstery fabrics, and eco-friendly finishes. All materials are ethically sourced."
    },
    {
      question: "Can I visit your workshop?",
      answer: "Absolutely! We offer private tours of our workshop by appointment. Please schedule a visit through our contact form."
    },
    {
      question: "Do you provide design consultations?",
      answer: "Yes, our design team offers complimentary 30-minute consultations to discuss your project and vision."
    }
  ];
  ...
  return (
    <div className="bg-[#F9F7F2] text-[#333333] overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl">
          ...
          >
            <a 
              ...
              className="inline-block border-2 border-[#C5A880] text-[#C5A880] rounded-full w-12 h-12 flex items-center justify-center animate-bounce"
            >
              <FaChevronDown />
            </a>
          </motion.div> */}
      ...
      {/* Tab Content */}
      <div id="contact-section" className="py-16 px-4 md:px-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="lg:w-2/5">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#2F4F4F] mb-2">Artisan Workshop</h3>
                ...
                >
                  <h3 className="text-xl font-semibold text-[#2F4F4F] mb-4">Connect With Us</h3>
                ...
                >
                  <h3 className="text-xl font-semibold text-[#2F4F4F] mb-3">Visit Our Showroom</h3>
                  <p className="text-gray-700 mb-4">
                    Experience our craftsmanship firsthand. Our showroom is open by appointment for personalized consultations.
                  </p>
                  <button 
                    onClick={() => setActiveTab('appointment')}
              ...
              <div className="lg:w-3/5">
                ...
                {submitSuccess ? (
                  ...
                  >
                    ...
                    <span>Thank you for your message! Our design team will contact you within 24 hours.</span>
                  </motion.div>
                ) : null}
                ...
                >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-3 py-3 border ${formErrors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C5A880] focus:border-transparent`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className={`w-full pl-10 pr-3 py-3 border ${formErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C5A880] focus:border-transparent`}
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border ${formErrors.subject ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C5A880] focus:border-transparent`}
                  ...
                  <div className="mb-6">
                    <label htmlFor="message" className="block text-gray-700 mb-2">Your Vision *</label>
                    <textarea
                      id="message"
                      name="message"
                      ...
                      onChange={handleChange}
                      rows="6"
                      className={`w-full px-4 py-3 border ${formErrors.message ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C5A880] focus:border-transparent`}
              ...
              >
                  ...
                  {faqItems.map((faq, index) => (
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <div>
                          <h3 className="text-xl font-semibold text-[#2F4F4F] mb-2">{faq.question}</h3>
                ...
                >
                  <p className="text-lg mb-6 max-w-2xl mx-auto text-gray-700">
                    Didn't find the answer you were looking for? Our team is ready to assist you.
                  </p>
                  <motion.button 
                    onClick={() => setActiveTab('contact')}
            ...
            >
              ...
              {submitSuccess ? (
                ...
                >
                  ...
                  <span>Your appointment has been scheduled! We'll send confirmation details to your email.</span>
                </motion.div>
              ) : null}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-4 py-3 border ${formErrors.date ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C5A880] focus:border-transparent`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={handleAppointmentChange}
                        className={`w-full px-4 py-3 border ${formErrors.time ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C5A880] focus:border-transparent`}
                      >
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <select
                      ...
                      onChange={handleAppointmentChange}
                      className={`w-full px-4 py-3 border ${formErrors.service ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C5A880] focus:border-transparent`}
                    >
                      <option value="">Select a service</option>
                      <option value="consultation">Design Consultation</option>
                      <option value="showroom">Showroom Visit</option>
                      <option value="custom">Custom Furniture Design</option>
                      <option value="repair">Furniture Repair/Restoration</option>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center min-w-[200px]">
              ...
              <div className="text-lg text-gray-600">Satisfaction Guarantee</div>
            </div>
          </motion.div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <p className="text-lg max-w-2xl mx-auto text-[#E8DFD1]">
              For personalized consultations beyond our regular hours, we're happy to accommodate evening appointments to discuss your bespoke furniture needs.
            </p>
            <motion.button 
              onClick={() => setActiveTab('appointment')}
      ...
      <div className="py-20 px-4 bg-gradient-to-br from-[#F5F1E9] to-[#E8DFD1]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p 
            ...
            transition={{ delay: 0.6 }}
          >
            Visit our showroom to touch, feel, and experience the quality that sets Hudson Furniture apart.
          </motion.p>
          <motion.div 
