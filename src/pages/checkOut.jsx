  ...
  return (
    <>
      <div
        ...
        className="flex gap-10 p-20 px-50 "
      >
        <form
          className="shadow rounded-md p-5 w-8/12 flex flex-col gap-5 bg-white"
          ...
          <div className="w-full flex flex-col gap-7">
            <div className="w-full flex gap-5 items-center">
              <div className="flex flex-col gap-2 w-full">
                ...
                <input
                  className="text-sm border rounded-md border-gray-100 px-3 py-2.5 w-full"
                  type="text"
                  placeholder="Mark"
                  name="firstName"
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              <textarea
                className="text-sm border rounded-md border-gray-100 px-3 py-2.5 h-40 w-full"
                name="description"
                onChange={handleChange}
              ></textarea>
            </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col">
              ...
              >
                <div className="flex gap-2 items-center">
                  <input
                    onClick={pickMethod}
                    onChange={handleChange}
                    className="bg-black accent-black"
                    type="radio"
                    name="payment"
                    id="creditCard"
                  />
                ...
                <div className="flex gap-2 items-center">
                  <div className="p-2 rounded-md border border-gray-100">
                    <img
                      className="h-4"
                      src="/src/assets/images/visa-10.svg"
                      alt=""
                    />
                  </div>
                  <div className="p-2 rounded-md border border-gray-100">
                    <img
                      className="h-4"
                      src="/src/assets/images/mastercard-modern-design-.svg"
                      alt=""
                    />
                  </div>
                </div>
              ...
              {method == "creditCard" && (
                <form
                  action=""
                  className="w-full border-l border-r  rounded  border-gray-100 p-2 flex flex-col gap-2"
                >
                  <div className="text-sm border rounded-md border-gray-100 px-3 py-2.5 w-full flex justify-between items-center">
                    <input
                      className="focus:white w-11/12 outline-none"
                      type="text"
                      name="cardNumber"
                      id=""
              ...
              >
                ...
                <div className="flex gap-2 items-center">
                  <div className="p-2 rounded-md border border-gray-100">
                    <img
                      className="h-4"
                      src="/src/assets/images/Paypal-11.svg"
                      alt=""
                    />
                  </div>
                </div>
              ...
              {method == "payPal" && (
                <form
                  action=""
                  className="w-full border-l border-r border-b  rounded  border-gray-100 p-2 flex flex-col gap-2"
                >
